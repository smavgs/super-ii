...
PRIVATE_KEYS = {
    ...
    "SUPERII_BRIDGE_TOKEN_ENCRYPTION_KEY",
    "SUPERII_DATABASE_URL",
    "SUPERII_POLICY_DATABASE_URL",
    "SUPERII_POLICY_TOKEN",
    "SUPERII_RUNTIME_TOKEN",
    "SUPERII_TRANSFER_TOKEN",
}
