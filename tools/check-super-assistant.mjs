...
requireText('config', 'config', "OPENROUTER_MODEL = 'openrouter/free'");
...
requireText('privacy', 'privacy', '<strong>OpenRouter Free Models Router and its selected model provider</strong>');
