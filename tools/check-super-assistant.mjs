...
requireText('client', 'client', "payload.code === 'provider_rate_limited'");
...
requireText('privacy', 'privacy', '<strong>OpenRouter and Meta</strong>');
requireText('privacy', 'privacy', 'This Contributor route permits prompts and outputs to be used to improve Meta’s products.');
