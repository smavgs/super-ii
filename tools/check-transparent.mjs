...
const requiredFiles = [
  ...
  'database/migrations/0021_transparent_foundation.sql', 'database/tests/transparent_smoke.sql',
];
...
const sourceFiles = Object.fromEntries(await Promise.all([
  ...
  'src/pages/account.astro', 'src/components/Footer.astro', 'src/lib/agent-auth.ts', 'database/migrations/0021_transparent_foundation.sql',
