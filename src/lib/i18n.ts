...
const productRussian: Record<string, string> = {
  ...
  "Your work, tools and account.": "Ваша работа, инструменты и аккаунт.",
  "AI setup": "Настройка ИИ",
  "Account": "Аккаунт",
  "Workspace sections": "Разделы рабочего пространства",
  "Workspace section": "Раздел рабочего пространства",
  "Continue with a repository or start something new.": "Продолжите работу с репозиторием или начните что-то новое.",
  "Create": "Создать",
  "Find your work": "Найти свою работу",
  "Search titles or names": "Поиск по названиям",
  "Type": "Тип",
  "All types": "Все типы",
  "Showing your 50 most recently updated repositories.": "Показаны 50 ваших репозиториев с самыми последними обновлениями.",
  "No repositories match. Try another search or type.": "Подходящих репозиториев нет. Измените запрос или тип.",
  "Show more repositories": "Показать ещё репозитории",
  "Make yourself at home": "Обустраивайтесь",
  "Create your first repository or bring work you already have.": "Создайте первый репозиторий или перенесите существующую работу.",
  "Set up your first AI agent": "Настроить первого ИИ-агента",
  "Imported sources": "Импортированные источники",
  "Review source versions and update checks.": "Проверяйте версии источников и обновления.",
  "New public source versions arrive as revisions for your review before publishing.": "Новые версии общедоступных источников поступают на проверку перед публикацией.",
  "Recent activity": "Недавние события",
  "Show more activity": "Показать ещё события",
  "No recent activity.": "Пока нет недавних событий.",
  "Choose a guide. Your progress stays on this device.": "Выберите инструкцию. Прогресс сохраняется на этом устройстве.",
  "Run your first agent with a free cloud model.": "Запустите первого агента с бесплатной облачной моделью.",
  "Open the settings you want to change.": "Откройте настройки, которые хотите изменить.",
  "Your introduction, interests and public links.": "О себе, интересах и общедоступных ссылках.",
  "Login, name and photo.": "Вход, имя и фото.",
  "Your subscriptions and payment history.": "Ваши подписки и история платежей.",
  "My organizations": "Мои организации",
  "Your memberships and team work.": "Ваше участие в организациях и командная работа.",
  "Add an agent": "Добавить агента",
  "Connections and permissions": "Подключения и разрешения",
  "Connect a compatible agent": "Подключить совместимого агента",
  "Issue an access token": "Выдать токен доступа",
  "Some Workspace details could not be loaded. Please refresh to try again.": "Не удалось загрузить часть рабочего пространства. Обновите страницу.",
  "Your work is temporarily unavailable": "Ваша работа временно недоступна",
  "Refresh to load your repositories.": "Обновите страницу, чтобы загрузить репозитории.",
  "Your public profile could not be loaded. Please refresh to try again.": "Не удалось загрузить профиль. Обновите страницу.",
  "Your memberships could not be loaded. Please refresh to try again.": "Не удалось загрузить ваши организации. Обновите страницу.",
  "Your work and account settings are available after authentication.": "Ваша работа и настройки аккаунта доступны после входа.",
  "Loading organization access…": "Загрузка доступа к организациям…",
