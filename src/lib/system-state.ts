...
export const systemState = {
  ...
  commerceMcp: '/mcp/commerce',
  commerceCatalog: '/.well-known/commerce.json',
  commerceA2a: '/.well-known/commerce-agent-card.json',
  robot: '/robot',
  robotMcp: '/mcp/robot',
  robotA2a: '/.well-known/robot-agent-card.json',
  transparent: '/transparent',
  transparentMcp: '/mcp/transparent',
  transparentGuide: '/transparent/agents.md',
  social: '/social',
  agents: '/agents',
